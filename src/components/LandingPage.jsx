            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-start justify-center h-full px-6 md:px-16 max-w-4xl">
                    ...
                    <div className="flex gap-4">
                        <button onClick={() => navigate("/colorfit")} className="bg-white text-black px-6 py-3 rounded-md shadow hover:bg-transparent hover:text-white hover:border hover:border-white hover:scale-105 transition transform duration-200">
                            Get Started
                        </button>
                    </div>
                </div>
            ...
            <section id="hero" className="pt-20 md:pt-28 px-6 bg-gradient-to-b from-blue-50 to-white">
                ...
                >
                    ...
                    <div className="text-center md:text-left md:w-3/5">
                        ...
                        <button onClick={() => navigate("/colorfit")} className="px-8 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-lg font-semibold rounded-full shadow-xl hover:scale-105 transition transform duration-200">
                            Try ColorFit
                        </button>
                    </div>
