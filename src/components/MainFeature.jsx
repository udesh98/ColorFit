...
import OutfitIllustration from './OutfitIllustration'; // Import your illustration component
...
export default function ColorMatcherApp() {
  ...
  return (
    <div className="min-h-screen font-sans text-gray-800 bg-white">
      ...
      <div className="pt-20 md:pt-28 px-6 flex items-center justify-center bg-gradient-to-b from-blue-100 to-white">
        <motion.div
