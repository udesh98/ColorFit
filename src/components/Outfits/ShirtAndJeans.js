export function ShirtAndJeans({ topColor, bottomColor }) {
  return (
    <svg width="150" height="200" viewBox="0 0 150 200" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      {/* Shorts */}
      <rect x="49" y="125" width="24" height="70" fill={bottomColor} stroke="black" strokeWidth="2" />
      <rect x="76" y="125" width="24" height="70" fill={bottomColor} stroke="black" strokeWidth="2" />
    </svg>
  );
}
